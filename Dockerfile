...
CMD airflow webserver -p 8080 && airflow scheduler && jupyter lab --ip=0.0.0.0 --no-browser --allow-root && dask-worker localhost:8786 --worker-port 8787 --memory-limit 2GB
